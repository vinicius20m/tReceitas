...
<div class="row">
      <div class="col-md-2 ">
            <div class="simple-card row">
                  ...
                  <ul class="profile-items" style="padding: 10px">
                        ...
                        <li>
                              <a class="selected-item" href="{{route('profile-favorites')}}"><i class="bi bi-star-fill"></i> Favoritas</a>
                        </li>
      ...
      <div class="col-md-9">
            ...
            <div class="simple-card" style="padding: 30px">
                  ...
                  <h3 class="text-center"><i class="bi bi-star-fill"></i> Minhas Receitas Favoritas: {{$user->favoritePosts->count()}}</h3>

                  <div class="gap-20"></div>
                  <div class="accordion" id="accordion">

                        @foreach ($user->favoritePosts->sortByDesc('created_at') as $post)
                  ...
                  @else
                  <h3 class="text-center">você ainda não favoritou uma receita</h3>
                  @endif
                  <div class="gap-40"></div>
            </div>
      </div>

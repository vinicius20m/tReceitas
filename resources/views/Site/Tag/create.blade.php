...
<div class="row">
      <div class="col-md-12">
      <div class="row">
            <h1 class="column-title col-md-4">Nova Tag</h1>
      ...
      {{-- CREATE FORM --}}
      <form id="contact-form" action="{{ route('tag-store') }}" method="post" role="form">
            @csrf
            ...
            <div class="row">
                  ...
                  <div class="form-group">
                        ...
                        <input id="title" name="title"
                              ...
                              value="{{ old('title') }}" placeholder="EX: Pipóca Doce"
                  ...
                  <div class="form-group">
                        ...
                        value="{{ old('description') }}" style="min-height: 70px" type="text">
                  </div>
                  </div>
            </div>
